...
Shader "LothsShade/Realtime"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 lerpResult185 = lerp( temp_cast_2 , temp_output_100_0 , ( 1.0 - temp_output_151_0 ));
		...
		ENDCG
		CGPROGRAM
		#pragma surface surf StandardCustomLighting keepalpha fullforwardshadows exclude_path:deferred nolightmap  nodirlightmap 
...
/*ASEBEGIN
Version=15600
1973;97;1504;974;2054.358;756.3751;1.681231;True;False
...
ASEEND*/
//CHKSM=99B24913A2824AD8A72263EB44F63A2CB2F86644